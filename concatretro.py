...
if __name__ == "__main__":
    ...
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert1/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat1/'
    finalfile = 'paramtest1.nc'
