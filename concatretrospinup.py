...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/aquiferretro/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/aquiferretro_convert/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/aquiferretro_concat/'
    finalfile = 'retrofinalnew.nc'
