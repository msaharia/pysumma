...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest2_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert2/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat2/'
    finalfile = 'paramtest2.nc'
