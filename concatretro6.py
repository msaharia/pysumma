...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest6_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert6/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat6/'
    finalfile = 'paramtest6.nc'
