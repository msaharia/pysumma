...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest9_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert9/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat9/'
    finalfile = 'paramtest9.nc'
