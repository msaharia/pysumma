...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest7_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert7/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat7/'
    finalfile = 'paramtest7.nc'
