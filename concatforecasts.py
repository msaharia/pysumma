...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/forecast_output/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/forecast_convert/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/forecast_concat/'
    forecastdir = '/glade/p/work/manab/SHARP/PNW_3L/output/forecast_all'
    finalfile = 'forecastfinalmean.nc'
    ...
    finalfilename = os.path.join(forecastdir, finalfile)
