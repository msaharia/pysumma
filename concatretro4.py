...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest4_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert4/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat4/'
    finalfile = 'paramtest4.nc'
