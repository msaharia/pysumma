...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest8_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert8/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat8/'
    finalfile = 'paramtest8.nc'
