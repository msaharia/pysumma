...
if __name__ == "__main__":
    ...
    outdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtest5_out/'                   #Directory containing SUMMA output
    convertdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconvert5/'
    concatdir = '/glade/p/work/manab/SHARP/PNW_3L/output/paramtestconcat5/'
    finalfile = 'paramtest5.nc'
